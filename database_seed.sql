...
(
    '26/1045', 'Tijani', 'Emmanuel', '2002-05-15', 'male', '(555) 111-2222', 'tijani.emmanuel@university.edu',
...
(
    '26/2089', 'Emily', 'Jones', '1995-11-23', 'female', '(555) 444-5555', 'emily.jones@gmail.com',
    '789 Maple Ave', 'Boston', 'MA', '02116', 'David Jones', '(555) 444-6666',
    'Aetna', 'AE-774829-01', 'GP-1123-B', 'None', 'Metformin 500mg daily', 'A-', NOW()
),
(
    '26/3012', 'Robert', 'Miller', '1960-03-08', 'male', '(555) 777-8888', 'r.miller@hotmail.com',
...
-- Link Student user to Tijani Emmanuel's patient profile ('26/1045')
...
(gen_random_uuid(), 'tijani emmanuel', 'student123', 'tijani.emmanuel@university.edu', 'student', 'Tijani Emmanuel', '26/1045');
...
-- Tijani Emmanuel's records
('26/1045', 'condition', 'Mild Asthma', 'Intermittent asthma triggered by exercise and pollen.', '2021-08-10', 'low', 'active', 'Dr. Jane Johnson', 'Keep inhaler on hand during physical activity.'),
('26/1045', 'allergy', 'Peanut Allergy', 'Severe anaphylactic reaction to peanuts.', '2008-04-12', 'high', 'chronic', 'Dr. Robert Carter', 'Epipen prescribed and active.'),
('26/1045', 'medication', 'Albuterol HFA Inhaler', '90 mcg/actuation inhaler. 2 puffs every 4-6 hours as needed for wheezing.', '2025-01-15', 'low', 'active', 'Dr. Jane Johnson', 'Asthma control is generally good.'),

-- Emily Jones's records
('26/2089', 'condition', 'Type 2 Diabetes', 'Diagnosed during routine physical. Managed with diet and oral medications.', '2024-02-18', 'medium', 'active', 'Dr. Jane Johnson', 'HbA1c last checked: 6.8%'),
('26/2089', 'surgery', 'Appendectomy', 'Laparoscopic appendectomy performed at General Hospital.', '2018-09-05', NULL, 'resolved', 'Dr. Sarah Higgins', 'Recovered fully without complications.'),

-- Robert Miller's records
('26/3012', 'condition', 'Hypertension', 'Essential hypertension. Blood pressure well controlled on daily Lisinopril.', '2015-10-22', 'medium', 'active', 'Dr. Jane Johnson', 'Monitor BP weekly at home.'),
('26/3012', 'condition', 'Hyperlipidemia', 'Elevated LDL cholesterol. Managed with statin therapy and low-fat diet.', '2019-05-14', 'medium', 'active', 'Dr. Jane Johnson', 'Follow up lipid panel in 6 months.');
...
(
    '26/1045', 'Tijani Emmanuel', 'blood', 'Allergy Panel - IgE', '2025-03-10', '2025-03-12', 'completed', 'Dr. Jane Johnson',
    '[
...
(
    '26/2089', 'Emily Jones', 'blood', 'Comprehensive Metabolic Panel & HbA1c', '2025-06-01', '2025-06-03', 'completed', 'Dr. Jane Johnson',
    '[
...
(
    '26/3012', 'Robert Miller', 'blood', 'Lipid Panel', '2025-06-20', NULL, 'pending', 'Dr. Jane Johnson',
    '[]'::jsonb,
...
(
    '26/1045', 'Tijani Emmanuel', 'Dr. Jane Johnson', '2025-01-15', 'routine', 
...
(
    '26/2089', 'Emily Jones', 'Dr. Jane Johnson', '2025-06-03', 'follow-up', 
...
('26/1045', 'Tijani Emmanuel', '(555) 111-2222', CURRENT_DATE, '09:00', 'Dr. Jane Johnson', 'General Checkup', 'confirmed', 'Routine checkup for asthma controls.'),
('26/2089', 'Emily Jones', '(555) 444-5555', CURRENT_DATE, '10:30', 'Dr. Jane Johnson', 'Follow-up', 'scheduled', 'Diabetes checkup.'),
('26/3012', 'Robert Miller', '(555) 777-8888', CURRENT_DATE + INTERVAL '1 day', '14:00', 'Dr. Jane Johnson', 'Consultation', 'scheduled', 'Review lipid panel results.');
